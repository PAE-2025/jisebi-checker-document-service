...
<body>
    <div class="dashboard-header">
        ...
        <div style="text-align: right; font-size: 0.7rem;" >
            ...
            <div>Disclaimer: This report is generated by computer. Further human check will be needed. </div>
        </div>
    </div>
    ...
    <div class="summary-box">
        ...
        <div class="section-card">
            ...
            <div class="section-body">
                <div class="reference-item">
                    <div>
                        <strong>Cannot be Calculated: </strong> Missing title or abstract
                    </div>
                </div>
            </div>
